...
import img_setup_bigwigs_p1 from "./images/mythic/ansurek/setup.bigwigs.p1.png"
import img_setup_bigwigs_p2 from "./images/mythic/ansurek/setup.bigwigs.p2.png"
...
<Image src={img_setup_bigwigs_p1} alt="" className="justify-self-center" />
<Image src={img_setup_bigwigs_p2} alt="" className="justify-self-center" />
...
<Tabs defaultValue="1" className="my-7">
  <TabsList>
...
<Tabs defaultValue="part1" className="mt-4">
  ...
  <div className="bg-muted rounded-lg px-5 pt-4 pb-7 mt-3">
    ...
    <TabsContent value="part3">
      ...
      ![](./images/mythic/ansurek/mechanic.web-blades.png)
    </TabsContent>
  ...
  <div className="bg-card rounded-lg px-5 pt-4 pb-7 mt-3">
    <TabsContent value="1">
      ...
      - <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-2">
          ...
          <div>
            <Image src={img_mechanic_shadowgate} alt="Phase 2 Shadowgate Bar" />
          </div>
        </div>
...
<div className="grid lg:grid-cols-[1fr_auto] gap-4">
  ...
  <div className="sticky top-0 [&>div]:my-0">
  | Time | Mechanic | Count |
  | --- | --- | --- |
...
<Tabs defaultValue="1" className="my-7">
  ...
  <div className="bg-card rounded-lg px-5 pt-4 pb-7 mt-3">
    ...
    <TabsContent value="2">
      ...
      1. Next we get 3 Summoned Acolytes while we dodge [Web Blades][web-blades]. 
          - Ansurek must be near <Star /> as she summons the Acolytes centered on the closest corner of the inner hexagon.
      2. The raid will focus on killing the adds with Ansurek positioned in cleave range of <Star /> until it dies, then moving to <Square />. Ranged will focus on the Acolyte at <Moon />.
      ...
      3. The acolytes will die and drop their [essence] on the floor *directly* in front of their markers. This will overlap with another [Web Blades][web-blades], so melee should be careful not to accidentally pick up an essence when dodging, nor should Ansurek be tanked directly in front of a marker.

      4. Ansurek will then put [Abyssal Infusion][abyssal-infusion] on two players that drop the [portals][abyssal-conduit] after 6 seconds. We want one of them in melee at <Cross /> and one at ranged on <Triangle />.
      ...
      5. As the portals open and players are dodging the [orbs][conduit-ejections] the first 3 players assigned to pick up [essences][essence] will be told by a WeakAura to pick up an essence. Any essence. Coordinate with your fellow essence-touchers as to which one you want.
    ...
    <TabsContent value="3">
      ...
      - Ansurek will then teleport to the middle and cast the [ring][frothing-gluttony].
        - Players who can teleport over the ring should do so in the area between <Square /> and <Circle /> to give the other players space to spread out with their [debuffs][abyssal-reverberation]. This is also where the next mechanics go.
      ...
      - The next sequence is [Web Blades][web-blades] while the 3 [essences][essence] are expiring and about to fall on the floor.
        - Essence holders will place their now expiring essences slightly behind <Square /> while avoiding dropping their essence directly on the marker; see the picture below. Anyone who does not have an essence should not be anywhere near <Square />.
        ...
        - The only hard requirement is that the essences are in the trapezoid formed  by <Star />, <Square /> and the pillars opposite them. It's incredibly dangerous if an essence were to be placed anywhere past the line drawn from <Square /> to the pillar opposite it, aka the next trapezoid.
    ...
    <TabsContent value="5">
      ...
      - Essences can be hapharzardly dropped near <Circle />. We are not going to be touching the essences again.
    </TabsContent>
    <TabsContent value="6">
      ...
      - Melee will incidentally kill the <Skull /> Acolyte and ranged can cleave off of the others so that we remove their shields to get some interrupts, but killing them is not important.
