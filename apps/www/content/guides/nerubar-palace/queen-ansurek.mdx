...
<Tabs defaultValue="part1" className="mt-4">
  ...
  <div className="bg-muted rounded-lg px-5 pt-4 pb-7 mt-3">
    ...
    <TabsContent value="part9">
      ...
      The 2nd set of [Reactive Toxin](https://www.wowhead.com/spell=437592/reactive-toxin) goes on 3 players instead of 2. To deal with this we will place them in a line with the radius of each debuff touching the miasma from the webs. Avoid overlapping the radius of the <Star /> debuff with the web miasma. If melee are too close to the boss and need to backup they can use the full size of the bomb.
