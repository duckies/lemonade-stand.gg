...
<Tabs defaultValue="part1" className="mt-4">
  <TabsList>
    <TabsTrigger value="part1"><span className="hidden md:block">Part </span>1</TabsTrigger>
    <TabsTrigger value="part2"><span className="hidden md:block">Part </span>2</TabsTrigger>
    <TabsTrigger value="part3"><span className="hidden md:block">Part </span>3</TabsTrigger>
    <TabsTrigger value="part4"><span className="hidden md:block">Part </span>4</TabsTrigger>
    <TabsTrigger value="part5"><span className="hidden md:block">Part </span>5</TabsTrigger>
    <TabsTrigger value="part6"><span className="hidden md:block">Part </span>6</TabsTrigger>
    <TabsTrigger value="part7"><span className="hidden md:block">Part </span>7</TabsTrigger>
    <TabsTrigger value="part8"><span className="hidden md:block">Part </span>8</TabsTrigger>
    <TabsTrigger value="part9"><span className="hidden md:block">Part </span>9</TabsTrigger>
    <TabsTrigger value="part10"><span className="hidden md:block">Part </span>10</TabsTrigger> 
    <TabsTrigger value="part11"><span className="hidden md:block">Part </span>11</TabsTrigger>
    <TabsTrigger value="part12"><span className="hidden md:block">Part </span>12</TabsTrigger>
  </TabsList>
