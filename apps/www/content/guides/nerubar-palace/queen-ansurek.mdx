...
<Image src={ansurek_setup_2} alt="BigWigs Setup 1" className="mx-auto"/>

<Image src={ansurek_setup_2} alt="BigWigs Setup 2" className="mx-auto" />
...
## Phase 1 Strategy
The [Phase 1 RaidPlan](https://raidplan.io/plan/X4iPdCthlYOmlR5R) has been made so that it lines up with the movement seen in log replays. 
