...
<Tabs defaultValue="part1" className="mt-4">
  ...
  <div className="bg-muted rounded-lg px-5 pt-4 pb-7 mt-3">
    ...
    <TabsContent value="part10">
      ...
      1. `0:35` — The [Reactive Froth](https://www.wowhead.com/spell=438846) bombs have finished exploding.
      2. `0:38` — [Web Blades](https://www.wowhead.com/spell=439299/web-blades) spawn. Since we have too little time to reconvene back at the bomb miasma, we instead dodge towards the opposite side of this platform section.
      3. The moment we can dodge the blades coincides with [Liquefy](https://www.wowhead.com/spell=436799/liquefy) puddles. So the ranged and melee groups should move into a safe position after the third blade spawns, then stack together for Liquefy.
